 ...
 */
public sealed class KtCallableMemberCall<S : KtCallableSymbol> : KtCall() {
    public abstract val partiallyAppliedSymbol: KtPartiallyAppliedSymbol<S, KtSignature<S>>
}

public val <S : KtCallableSymbol> KtCallableMemberCall<S>.symbol: S get() = partiallyAppliedSymbol.symbol
 ...
 */
public sealed class KtVariableAccessCall : KtCallableMemberCall<KtVariableLikeSymbol>()
